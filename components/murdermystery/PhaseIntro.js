...
export default function PhaseIntro({
    ...
    return (
        <div style={{
            ...
            background: `url("/game_assets/images/Game_Setting.png") center/cover no-repeat`,
            ...
            <div style={{
                ...
                <h1 style={{ fontSize: '3rem', margin: '0 0 20px 0', color: '#61dafb', textShadow: '0 2px 10px rgba(0,0,0,0.8)' }}>The Setting</h1>
